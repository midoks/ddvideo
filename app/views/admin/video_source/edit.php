	...
	<form class="layui-form layui-form-pane ok-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="name" placeholder="请输入来源名称" autocomplete="off" class="layui-input" lay-verify="required" value="{name}">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="mark" autocomplete="off" class="layui-input" lay-verify="required" value="{mark}">
			</div>
		</div>
