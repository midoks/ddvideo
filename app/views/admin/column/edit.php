...
<div class="ok-body">
	...
	<form class="layui-form layui-form-pane ok-form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="type">
					<option value="0" <?php if ($type == "0") {echo 'selected="selected"';}?>>基本</option>
					<option value="1" <?php if ($type == "1") {echo 'selected="selected"';}?>>外链</option>
				</select>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="value" placeholder="请输入内容" class="layui-input" lay-verify="required" value="<?php echo $value; ?>">
			</div>
		</div>
